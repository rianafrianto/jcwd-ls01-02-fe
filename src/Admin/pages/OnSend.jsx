      ...
      <div className="bg-green-400 w-full h-full pt-16 pl-64">
        <div className="py-8 px-12">
          <div className="flex h-12 w-full mb-16">
            <div className="w-44 h-12 pt-3 text-center bg-green-500 border">
              Dalam Pengiriman
            </div>
          ...
          <div className="w-full h-full border bg-white mb-6">
            <div className="flex h-16 mb-4 mt-4">
            ...
            <div className="flex justify-between h-12 bg-red-300 mb-7">
